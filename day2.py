inp = """Game 1: 1 red, 3 blue, 11 green; 1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green
...
for game in inp.split("\n"):
    gamevalid = True
    for rnd in game.split(": ")[1].split("; "):
        for color in rnd.split(", "):
            colorvalid = True
            ...
            if not colorvalid:
                gamevalid = False
    if gamevalid:
        sum += int(game.split(":")[0].split(" ")[1])
    print(game.split(":")[0].split(" ")[1], gamevalid)
...
for game in inp.split("\n"):
    ...
    for rnd in game.split(": ")[1].split("; "):
        for color in rnd.split(", "):
            colorvalid = True
            if color.split(" ")[1] == "red":
                nr = int(color.split(" ")[0])
                if nr > rmin:
                    rmin = nr
            if color.split(" ")[1] == "green":
                ng = int(color.split(" ")[0])
                if ng > gmin:
                    gmin = ng
            if color.split(" ")[1] == "blue":
                nb = int(color.split(" ")[0])
                if nb > bmin:
                    bmin = nb
    print(game, rmin, gmin, bmin)
    sum += rmin*gmin*bmin
    #print(game.split(":")[0].split(" ")[1], gamevalid)
    print(sum)